...
<article class="page-container">
	<form action="${pageContext.request.contextPath}/students/addStudent" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="width:80px;margin-left:20px"><span class="c-red">*</span>年级：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="grade" name="grade">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3" style="width:110px;margin-left:-10px"><span class="c-red">*</span>老师姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
