...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="member_student_add('添加学生','${pageContext.request.contextPath}/students/addStudent','500','300')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加学生</a></span> <span class="r">共有数据：<strong>${num }</strong> 条</span> </div>
	<div class="mt-20">
		...
		<tbody>
		 <c:forEach items="${studentList}" var="student" varStatus="studentStatus">                         
			<tr class="text-c">
				...
				<td class="td-manage"> <a title="编辑" href="javascript:;" onclick="member_edit('编辑','${pageContext.request.contextPath}/students/updateStudent?id='+${student.id},${student.id},'','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">编辑【&#xe6df;】</i> <a title="删除" href="javascript:;" onclick="member_del(this,${student.id})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">删除【&#xe6e2;】</i></a></td>
			</tr>
		 </c:forEach>	
		</tbody>
	</table>
...
/*用户-添加*/
function member_student_add(title,url,w,h){
